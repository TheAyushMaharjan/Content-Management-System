<x-admin-app-layout>
    ...
    <div x-data :class="$store.sidebar.isCollapsed ? 'ml-20' : 'ml-10'" class="py-6 transition-all duration-300">
                ...
                <div class="container pt-2">
                    ...
                    <div class="flex gap-6 pt-6">
                        ...
                        <div class="w-full lg:w-2/5 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                            <form action="{{ route('admin.blog.storeCategory') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="mb-4">
            ...
            <select name="category_id" id="category_id" class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-xs dark:bg-gray-700 dark:text-gray-100" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" id="title" class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-xs dark:bg-gray-700 dark:text-gray-100" required>
        </div>
        </div>
        <!-- Slug Input -->
        <div class="mb-4">
            <label for="slug" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Slug *</label>
            <input type="text" name="slug" id="slug" class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-xs dark:bg-gray-700 dark:text-gray-100" required>
        </div>
    
        <!-- Content Input -->
        <div class="mb-4">
            <label for="content" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Content *</label>
            <textarea name="content" id="content" class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-xs dark:bg-gray-700 dark:text-gray-100" required></textarea>
        </div>
    
        <!-- Image Input -->
        <div class="mb-4">
            <label for="image" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Image</label>
            <input type="file" name="image" id="image" class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-xs dark:bg-gray-700 dark:text-gray-100">
        </div>
    
        <!-- Author Input -->
        <div class="mb-4">
            <label for="author" class="block text-xs font-medium text-gray-700 dark:text-gray-300">Author *</label>
            <input type="text" name="author" id="author" class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-xs dark:bg-gray-700 dark:text-gray-100" required>
        </div>
                                                        ...
                                                        @foreach ($blogsData as $category)
                                                            <tr class="hover:bg-gray-200 dark:hover:bg-gray-600 border-b">
                                                                ...
                                                                <td class="px-3 py-2 text-gray-700 dark:text-gray-100 border flex items-center space-x-2">
                                                                    ...
                                                                    <form action="{{ route('admin.blog.categoryEdit', $category->id) }}" method="POST" class="inline">
                                                                        @csrf
                                                                        @method('PUT')
