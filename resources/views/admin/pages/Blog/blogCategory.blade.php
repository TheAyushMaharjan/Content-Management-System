                ...
                <div class="flex gap-6 pt-6">
                    ...
                    <div class="w-full lg:w-2/5 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-sm">
                        <form action="{{ route('admin.blog.store') }}" method="POST">
                            @csrf
                            <div class="space-y-2">
                                <h2 class="text-gray-700 text-center dark:text-gray-100 text-2xl font-bold py-2">Category Form</h2>
                                <div>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" class="w-full px-2 py-1 border border-gray-300 dark:border-gray-600 rounded text-xs dark:bg-gray-700 dark:text-gray-100" placeholder="Enter Description"  style="resize: none;"></textarea>
                                </div>
                            ...
                            <table id="categoryTable" class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="bg-gray-100 dark:bg-gray-700">
                                        <th class="px-5 py-3 text-sm font-semibold text-gray-700 dark:text-gray-100 border-b dark:border-gray-600">Category Name</th>
                                        <th class="px-5 py-3 text-sm font-semibold text-gray-700 dark:text-gray-100 border-b dark:border-gray-600">Icon Name</th>
                                        <th class="px-5 py-3 text-sm font-semibold text-gray-700 dark:text-gray-100 border-b dark:border-gray-600">Description</th>
                                ...
                                <tbody>
                                    @foreach ($blogsData as $category)
                                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition-all duration-200 border-b dark:border-gray-700">
                                            <td class="px-5 py-3 text-gray-800 dark:text-gray-100">{{ $category->category_name }}</td>
                                            <td class="px-5 py-3 text-gray-800 dark:text-gray-100">{{ $category->icon_name }}</td>
                                            <td class="px-5 py-3 text-gray-800 dark:text-gray-100">{{ $category->description }}</td>
                                            <td class="px-5 py-3">
                                            ...
                                            <td class="px-5 py-3 flex items-center space-x-3">
                                                <a href="{{ route('admin.blog.edit', $category->id) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-600 transition-colors">Edit</a> 
