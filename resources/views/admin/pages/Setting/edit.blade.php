        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{route('admin.setting.update',$articles->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div>
                            <div class="container flex justify-between items-center">
                                ...
                                <div class="create  ">
                                    <a class=" px-4 py-2 flex items-center" href="{{route('admin.setting.index')}}"><i
