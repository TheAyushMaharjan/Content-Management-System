            ...
            <div class="container mx-auto p-4">
                ...
                <div class="flex gap-6 pt-6">
                    ...
                    <div class="w-full lg:w-2/5 bg-white dark:bg-[#1B263B] p-4 rounded-lg shadow-sm">
                        <form action="{{ route('admin.gallerySetup.store') }}" method="POST"
                            ...
                            <div class="mb-4">
                                <label for="slug"
                                    class="block text-xs font-medium text-gray-700 dark:text-gray-300">Slug
                                    *</label>
                            ...
                            <div class="mb-4">
                                <label for="content"
                                    class="block text-xs font-medium text-gray-700 dark:text-gray-300">Content
                                    *</label>
                    ...
                    <div class="w-full lg:w-3/5 bg-white dark:bg-[#1B263B] p-6 rounded-2xl shadow-lg">
                        <h2 class="text-gray-800 dark:text-gray-100 text-2xl font-semibold text-center mb-4">Category
                            List</h2>
                            ...
                            <table id="categoryTable" class="w-full text-left border-collapse text-xs">
                                ...
                                <tbody>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-5 py-3 text-gray-800 dark:text-gray-100">{{ $category->category_id
                                            }}</td>
                                        <td class="px-5 py-3 text-gray-800 dark:text-gray-100">{{ $category->title }}
                                        </td>
                                        <td class="px-5 py-3 text-gray-800 dark:text-gray-100">{{ $category->slug }}
                                        </td>
                                        <td class="px-5 py-3 text-gray-800 dark:text-gray-100">{{ $category->content }}
                                        </td>
                                        <td class="py-2 px-4 border-b">
                                            @if($category->image)
                                            <img src="{{ asset('storage/' . $category->image) }}" alt="Blog Image"
                                        ...
                                        <td class="px-5 py-3 flex justify-center items-center space-x-3">
                                            ...
                                            @can('delete gallery setup')
                                            <form action="{{ route('editor.gallerySetup.destroy', $category->id) }}"
                        ...
                        <div class="mt-4 flex justify-between items-center text-xs">
                            <div class="text-gray-700 dark:text-gray-300">
                                Showing {{ $mediaData->firstItem() }} to {{ $mediaData->lastItem() }} of {{
                                $mediaData->total() }} entries
                            </div>
