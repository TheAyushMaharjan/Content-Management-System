        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('editor.profile.edit')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('editor.logout') }}">
                            ...
                            <x-dropdown-link :href="route('editor.logout')"
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            ...
            <div class="mt-3 space-y-1">
                <x-responsive-nav-link :href="route('editor.profile.edit')">
                    {{ __('Profile') }}
                </x-responsive-nav-link>
                ...
                <form method="POST" action="{{ route('editor.logout') }}">
                    ...
                    <x-responsive-nav-link :href="route('editor.logout')"
                            onclick="event.preventDefault();
                                        this.closest('form').submit();">
                        {{ __('Log Out') }}
                    </x-responsive-nav-link>
