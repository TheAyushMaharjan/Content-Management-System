<nav x-data>
    ...
    <div :class="$store.sidebar.isCollapsed ? 'w-20' : 'w-64'" 
         class="bg-[#0D1B2A] shadow-lg h-screen p-4 pb-8 flex flex-col transition-all duration-300 fixed">
        <div class="whole flex flex-col h-full">
            <div class="Content flex-1 overflow-y-auto">
                <!-- Sidebar Header -->
                <div class="flex justify-between items-center mb-4">
                    <h2 x-show="!$store.sidebar.isCollapsed" class="text-xl font-bold text-[#E0E1DD]">CMS</h2>
                    <button @click="$store.sidebar.toggle()" class="text-[#E0E1DD] p-2 focus:outline-none">
        ...
        <ul class="space-y-2 flex-1 overflow-y-auto">
            <!-- Dashboard -->
            <li>
                <a href="{{ route('admin.dashboard') }}" class="flex items-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" 
                         stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li>
                <details class="group">
                    <summary class="flex items-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" 
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <li>
                <details class="group">
                    ...
                    <ul x-show="!$store.sidebar.isCollapsed" class="pl-4 mt-2 text-sm space-y-1">
                        <li><a href="{{route('admin.blog.blogCategory')}}" class="flex items-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded">Blog Category</a></li>
                        <li><a href="{{route('admin.blogSetup.blogSetup')}}" class="flex items-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded">Blog Setup</a></li>
                    </ul>
                </details>
            </li>
            <!-- Media Management -->
            <li>
                <details class="group">
                    ...
                    <ul x-show="!$store.sidebar.isCollapsed" class="pl-4 mt-2 text-sm space-y-1">
                        <li><a href="{{route('admin.galleryCategory.galleryCategory')}}" class="flex items-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded">Gallery Category Setup</a></li>
                        <li><a href="{{route('admin.gallerySetup.gallerySetup')}}" class="flex items-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded">Gallery Setup</a></li>
                        <li><a href="#" class="flex items-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded">Preview</a></li>
            ...
            <li>
                <details class="group">
                    ...
                    <ul x-show="!$store.sidebar.isCollapsed" class="pl-4 mt-2 text-sm space-y-1">
                        <li><a href="#" class="flex items-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded">Website Heading & Logo Setting</a></li>
            ...
            <li class=" list-none border-t border-gray-700 ">
                ...
                <div class="flex flex-col text-sm space-y-2">
                    <!-- Profile Link -->
                    <a href="{{ route('admin.profile.edit') }}" class="flex items-center justify-center p-2 text-[#E0E1DD] hover:bg-gray-700 rounded">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" 
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit" class="flex items-center justify-center p-2 w-full text-[#E0E1DD] hover:bg-gray-700 rounded">
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" 
                                 stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
